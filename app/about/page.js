...
export default async function AboutPage() {
    ...
    const cards = [
        ...
        { icon: '💎', title: 'Our Promise', desc: 'Quality food, fast delivery, and the best offers — that\'s the FooodieClub promise to every customer.' },
    ];
    return (
        <>
            ...
            <main style={{ minHeight: '60vh', padding: '3rem 2rem', maxWidth: 1000, margin: '0 auto' }}>
                <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
                    <h1 style={{ fontFamily: 'Outfit', fontSize: '2.5rem', fontWeight: 800, marginBottom: '1rem' }}>About <span style={{ color: '#4338ca' }}>FooodieClub</span></h1>
