...
const empty = { name: '', description: '', image: '', categoryId: null, price: 0, isAvailable: true, isVeg: false, sortOrder: 0 };
...
export default function AdminMenu() {
    ...
    const save = async () => {
        ...
        const payload = { ...form, categoryId: Number(form.categoryId) || null, price: Number(form.price) };
        const res = await fetch('/api/admin/menu', {
        ...
        <div className="admin-page">
            ...
            <div className="table-container">
                <table className="admin-table">
                    <thead><tr><th>Image</th><th>Name</th><th>Category</th><th>Price</th><th>Available</th><th>Type</th><th>Actions</th></tr></thead>
                    <tbody>
                        {items.map(m => (
                            <tr key={m.id}>
