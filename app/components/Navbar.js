...
export default function Navbar({ settings }) {
    const { location, setLocation: onSetLocation, clearLocation: onClearLocation, deliveryAvailable } = useLocation();
            ...
            <nav className="navbar" id="navbar">
                <div className="navbar-inner">
                    ...
                    <div className={`navbar-right ${mobileOpen ? 'open' : ''}`}>
                        ...
                        <Link href="/#party-section" className="nav-link">Party</Link>
