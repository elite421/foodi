        ...
        <footer className="footer" id="footer">
            <div className="footer-grid">
                <div className="footer-brand">
                    <div className="footer-logo">{s.siteName || 'Foodi'}<span>Club</span></div>
                ...
                <div className="footer-links">
                    ...
                    <ul>
                        ...
                        <li><a href={`mailto:${s.email || ''}`}>{s.email || 'support@foodiclub.com'}</a></li>
                        <li><span>{s.address || ''}</span></li>
                    </ul>
                </div>
            </div>
            <div className="footer-bottom">
                <p>&copy; {new Date().getFullYear()} {s.siteName || 'FoodiClub'}. All rights reserved.</p>
