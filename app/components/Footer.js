            ...
            <div className="footer-grid">
                ...
                <div className="footer-links">
                    ...
                    <ul>
                        ...
                        <li><Link href="/#party-section">Party Bookings</Link></li>
                ...
                <div className="footer-links">
                    ...
                    <ul>
                        ...
                        <li><span>Shop No. T5-G/55<br />S.No.7/1 to 7/5 8/1 F Residences,<br />PUNE CITY PUNE<br />Pune M Corp.) 411014</span></li>
                    </ul>
                </div>
            </div>
