...
async function main() {
    ...
    await prisma.admin.upsert({
        ...
        update: {},
        create: { username: 'admin', password: hash, name: 'FoodiClub Admin' }
    });
    ...
    await prisma.hero.upsert({
        ...
        update: {},
        create: {
            id: 1, title: 'Welcome to FoodiClub!',
    ...
    await prisma.settings.upsert({
        ...
        update: {},
        create: {
            id: 1, siteName: 'FoodiClub', tagline: 'Your favorite restaurant, online', domain: 'foodiclub.com',
            phone: '1800-123-4567', email: 'support@foodiclub.com',
            address: '123 Food Street, New Delhi, India',
            facebook: 'https://facebook.com/foodiclub', instagram: 'https://instagram.com/foodiclub',
            twitter: 'https://twitter.com/foodiclub',
